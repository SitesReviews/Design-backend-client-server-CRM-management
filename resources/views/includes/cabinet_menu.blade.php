...
<nav class="mb-5 py-4 border-bottom d-flex align-items-center text-center">
    <a href="{{route('personal.orders')}}" class="nav-link flex-fill flex-md-grow-0 fw-medium me-0 me-sm-5 @if ($currentRoute === 'orders') active @endif"><i class="fa-regular fa-rectangle-history me-2"></i>Orders</a>
