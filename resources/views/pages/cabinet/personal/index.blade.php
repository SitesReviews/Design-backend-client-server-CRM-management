                ...
                <div class="col-lg-12 col-xl-9 mx-auto">
                    <div class="ucard">
                        <div class="d-flex align-items-center p-4 bg-light border-bottom">
                            ...
                            <div class="ms-4">
                                <div class="fs-20 fw-medium mb-0">uNerd</div>
                            ...
                            <div class="ms-auto">
                                <a href="/balance.php" class="btn btn-sm btn-dark fs-16" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Пополнить баланс">
                                    <span class="ms-2 me-3">0 RUB</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-4 mb-4">
                                    <div class="border rounding shadow--hover px-3 py-4 text-center h-100">
                                        ...
                                        <a href="/orders.php" class="btn btn-sm btn-light">Перейти</a>
                                    </div>
                                </div>
                                <!-- Item -->
                                <div class="col-sm-6 col-lg-4 mb-4">
                                ...
                                <div class="col-sm-6 col-lg-4 mb-4">
                                    <div class="border rounding shadow--hover px-3 py-4 text-center h-100">
                                        ...
                                        <a href="/balance.php" class="btn btn-sm btn-light">Перейти</a>
                                    </div>
                                </div>
                                <!-- Item -->
                                <div class="col-sm-6 col-lg-4 mb-4">
                                    <div class="border rounding shadow--hover px-3 py-4 text-center h-100">
                                        ...
                                        <a href="/partner-program.php" class="btn btn-sm btn-light">Перейти</a>
                                    </div>
                                </div>
                                <!-- Item -->
                                <div class="col-sm-6 col-lg-4 mb-4">
                                ...
                                <div class="col-sm-6 col-lg-4 mb-4">
                                    <div class="border rounding shadow--hover px-3 py-4 text-center h-100">
                                        ...
                                        <a href="/personal-edit.php" class="btn btn-sm btn-light">Перейти</a>
                                    </div>
                                </div>
                                <!-- Item -->
                                <div class="col-sm-6 col-lg-4 mb-4">
                                    <div class="border rounding shadow--hover px-3 py-4 text-center h-100">
                                        ...
                                        <a href="/support.php" class="btn btn-sm btn-light">Перейти</a>
                                    </div>
                                </div>
                            </div>
                        </div>
